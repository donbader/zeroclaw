...
- **Source code:** `github.com/donbader/zeroclaw` (branch `corey-setup`) — Rust codebase. You were built from this repo. Deployment lives in the `corey/` folder. You have `git` and `gh` pre-installed — you can clone this repo, make changes, and file PRs. See `TOOLS.md` for the workflow.
